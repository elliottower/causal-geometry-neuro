...
We compared four encoder architectures across 73 regions to test whether adding a label-conditioned prior (pi-VAE; \citealp{zhou2020learning}) improves upon the structured split:
