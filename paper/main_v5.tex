...
\textbf{What is missing.} No prior work systematically compares metric families on the same neural data, validates subspace methods against optogenetic ground truth, or tests whether the IIA vacuity concern applies to biological subspace estimation.
